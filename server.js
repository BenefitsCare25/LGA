...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", "https://api.apify.com", "https://api.openai.com", "https://graph.microsoft.com", "https://login.microsoftonline.com", "https://api.github.com", "https://github.com"]
        }
    }
}));
...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'lead-generator.html'));
});

// Serve email automation page
app.get('/email-automation', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'email-automation.html'));
});
